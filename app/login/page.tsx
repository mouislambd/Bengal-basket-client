...
export default function LoginPage() {
    ...
    const handleDemoLogin = () => {
        setEmail("demo@bengalbasket.com");
    ...
    return (
        <div className="min-h-[80vh] flex items-center justify-center bg-gray-50 px-4">
            <div className="bg-white p-8 rounded-xl shadow-md w-full max-w-md">
                <h1 className="text-2xl font-bold text-emerald-950 mb-6 text-center">Login</h1>
                ...
                <button
                    ...
                    type="button"
                    className="w-full border-2 border-amber-500 text-amber-600 py-2 rounded-lg font-medium mb-4 hover:bg-amber-50 transition"
                >
